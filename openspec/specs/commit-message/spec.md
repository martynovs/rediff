...
## Purpose
The shared commit-message popup — a commit's full message shown over whatever summoned it, and the
message banner above a single commit's diff — so reading why a change was made never costs the place
the reader was in.
