...
## Purpose
Getting around a review: the sidebar file list, jumping to a file by digit or by fuzzy match, hopping
hunks across the whole stream, and the rule that incremental motion moves the cursor rather than the
viewport.
